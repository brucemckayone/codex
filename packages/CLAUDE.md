...
Master navigation guide for the Codex platform package layer. This document provides a comprehensive overview of all 12 packages, their relationships, and how to use them to build and extend the platform.

**Status**: Complete - All 12 packages documented and indexed
...
Codex organizes all business logic into **12 packages** across three architectural layers:
...
| **Test setup** | @codex/test-utils | Database helpers, test utilities |
...
└── @codex/test-utils - Test infrastructure
    |
    v
...
@codex/observability
  ├─ depends: (minimal, self-contained)
  └─ used by: [@codex/worker-utils], [all workers]
...
| @codex/test-utils | 0.1.0 | Testing | Node 18+ |
