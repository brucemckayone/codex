...
> = {
  ...
  lava: {
    ...
    controls: [
      ...
      {
        kind: 'slider',
        key: 'shader-lava-crust',
        label: 'Crust Darkness',
        min: 0.3,
        max: 1.0,
        step: 0.05,
        format: 'fixed2',
  ...
  tendrils: {
    ...
    controls: [
      ...
      {
        kind: 'slider',
        key: 'shader-tendrils-fade',
        label: 'Tendril Density',
        min: 0.3,
        max: 1.0,
        step: 0.05,
        format: 'fixed2',
  ...
  geode: {
    ...
    controls: [
      ...
      {
        kind: 'slider',
        key: 'shader-geode-warp',
        label: 'Band Irregularity',
        min: 0.3,
        max: 1.5,
        step: 0.05,
        format: 'fixed2',
      ...
      {
        kind: 'slider',
        key: 'shader-geode-cavity',
        label: 'Crystal Cavity',
        min: 0.1,
        max: 0.4,
        step: 0.01,
        format: 'fixed2',
  ...
  ocean: {
    ...
    controls: [
      {
        kind: 'slider',
        key: 'shader-ocean-caustic-scale',
        label: 'Caustic Scale',
        min: 1.0,
        max: 4.0,
        step: 0.5,
  ...
  bismuth: {
    ...
    controls: [
      {
        kind: 'slider',
        key: 'shader-bismuth-terraces',
        label: 'Terrace Levels',
        min: 4,
        max: 12,
        step: 1,
        format: 'int',
      ...
      {
        kind: 'slider',
        key: 'shader-bismuth-iridescence',
        label: 'Iridescence',
        min: 0.3,
        max: 1.5,
        step: 0.05,
  ...
  pearl: {
    ...
    controls: [
      ...
      {
        kind: 'slider',
        key: 'shader-pearl-fresnel',
        label: 'Iridescence Power',
        min: 1.0,
        max: 5.0,
        step: 0.1,
        format: 'fixed1',
  ...
  vortex: {
    ...
    controls: [
      ...
      {
        kind: 'slider',
        key: 'shader-vortex-spiral',
        label: 'Arm Brightness',
        min: 0.3,
        max: 1.0,
        step: 0.05,
        format: 'fixed2',
  ...
  spore: {
    ...
    controls: [
      ...
      {
        kind: 'slider',
        key: 'shader-spore-sensor-offset',
        label: 'Sensor Reach',
        min: 1.0,
        max: 8.0,
        step: 0.5,
