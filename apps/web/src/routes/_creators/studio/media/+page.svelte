<!--
  @component CreatorStudioMediaPage

  Media management page in the personal Creator Studio. Displays an upload zone
  and a grid of existing media items with pagination. Supports edit metadata
  and delete actions with server-side filtering by media type and status.
-->
<script lang="ts">
...
<svelte:head>
  <title>{m.media_title()} | My Studio</title>
</svelte:head>
