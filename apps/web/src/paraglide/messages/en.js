 ...
 */
/* @__NO_SIDE_EFFECTS__ */
export const creator_content_count = (params) => `${params.count} content`
 ...
 */
/* @__NO_SIDE_EFFECTS__ */
export const creator_visit_twitter = () => `Visit Twitter profile`
 ...
 */
/* @__NO_SIDE_EFFECTS__ */
export const creator_visit_youtube = () => `Visit YouTube channel`
 ...
 */
/* @__NO_SIDE_EFFECTS__ */
export const creator_visit_instagram = () => `Visit Instagram profile`
 ...
 */
/* @__NO_SIDE_EFFECTS__ */
export const errors_resource_not_found = () => `The resource you're looking for doesn't exist.`
 ...
 */
/* @__NO_SIDE_EFFECTS__ */
export const errors_login_required = () => `Please sign in to access this resource.`
 ...
 */
/* @__NO_SIDE_EFFECTS__ */
export const errors_server_error = () => `Server Error`
 ...
 */
/* @__NO_SIDE_EFFECTS__ */
export const input_show_password = () => `Show password`
 ...
 */
/* @__NO_SIDE_EFFECTS__ */
export const input_hide_password = () => `Hide password`
