...
## ⚠️ R7 promotions — R9-R15 ALL applied; **Round 2 first pass CLOSED at iter-024; Round 3 effectiveness audits underway**
...
- **R15 (applied iter-029)** — `types:as-cast-without-guard` from iter-028 R7 standard 3-hit. 4-exception list (drizzle-infinite-recursion, framework-default-init, proxy-target, type-test). HSTS (`security:missing-hsts`) closed via Round 3 Tier 7.A — companion fix to R10.
...
| `types:as-cast-without-guard` | **3** | 2026-04-26 | 2026-04-26 | **PROMOTED → R15 (APPLIED iter-029)**, cumulative cycle_density=7. R-rule has 4 reason-code exceptions: drizzle-infinite-recursion, framework-default-init, proxy-target, type-test. `as unknown as` is separate fingerprint NOT covered. (Codex-lqvw4.9, .12, Codex-qmrwe) |
