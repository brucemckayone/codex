...
describe('Paid Content Purchase Flow', () => {
  test(
    'should complete full paid content purchase flow',
    async () => {
  ...
  test(
    'should handle duplicate webhook gracefully (idempotency)',
    async () => {
  ...
  test(
    'should return 409 when attempting to purchase already-owned content',
    async () => {
