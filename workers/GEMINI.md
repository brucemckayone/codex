...
```bash
cd workers/ecom-api
â”œâ”€â”€ workers/admin-api - Admin dashboard and analytics
â”œâ”€â”€ workers/media-api - Media transcoding and streaming
â”œâ”€â”€ workers/notifications-api - Email and notifications
â””â”€â”€ workers/organization-api - Organization managementpnpm dev  # Starts on http://localhost:42072
```
...
â”œâ”€â”€ workers/media-api - Media transcoding and streaming
â”œâ”€â”€ workers/notifications-api - Email and notifications
â””â”€â”€ workers/organization-api - Organization management```
